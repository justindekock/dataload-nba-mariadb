...
class TeamData:
    ...
    def get_team_df(self):
        return self.clean_df[['team_id', 'team', 'team_name', 'lg']].drop_duplicates()
    ...
    def get_tbox_df(self):
        return self.clean_df[['game_id', 'season_id', 'team_id', 'mins', 'pts', 'ast', 
           'reb', 'stl', 'blk', 'oreb', 'dreb', 'pm', 'tov', 'pf']].copy()
    
    def get_tshtg_df(self):
        return self.clean_df[['game_id', 'season_id', 'team_id', 'fgm', 'fga', 'fg3m', 
